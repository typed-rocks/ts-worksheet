...
<img src="https://raw.githubusercontent.com/typed-rocks/ts-worksheet/main/imgs/result.gif" width=500> 
  ...
  <h3>Compatible with the major runtimes...</h3>
    <div class="mt-3 d-flex justify-content-center gap-4">
        ...
        <img src="https://raw.githubusercontent.com/typed-rocks/ts-worksheet/main/imgs/deno_black.png" width="80"/>
    </div>
<div>
    <h3>...and languages</h3>
    <div class="mt-3 d-flex justify-content-center gap-4">
...
<div align="center">
    ...
    <div>
        <div >
            <h3>Results during ongoing process</h3>
            <p>Show results for still running nodeJS code.
            You want to get the results of your running server or setInterval? We got you covered (macOS and linux)</p>
        </div>
        <div>
            <img src="https://raw.githubusercontent.com/typed-rocks/ts-worksheet/main/imgs/interval.png" width=300/>
        </div>
    </div>
    <hr>
    <div>
  ...
  <p>Easily switch between <img src="https://raw.githubusercontent.com/typed-rocks/ts-worksheet/main/imgs/bun.png" width="25"/>, <img src="https://raw.githubusercontent.com/typed-rocks/ts-worksheet/main/imgs/deno_black.png" width="25"> and <img
